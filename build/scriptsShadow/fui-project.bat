...
set CLASSPATH=%APP_HOME%\lib\fui-server.jar

@rem Execute fui-project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FUI_PROJECT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%FUI_PROJECT_EXIT_CONSOLE%" exit 1
exit /b 1
